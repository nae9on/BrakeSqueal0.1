...
def create_MCK_usr(obj, sparse_list, omega):
        r"""
        IN: obj
        sparse_list: list of matrices
        omega: value of parameter for which matrices are realized

        OUT: assembled matrices
	  ...
	  for i in range(0,len(sparse_list)):
        ...
        M = obj.M(M1,omega)
        C = obj.C(D1,DG,DR,D4,omega)
        K = obj.K(K1,KR,KGeo,omega)
